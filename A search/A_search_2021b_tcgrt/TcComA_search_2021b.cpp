...
///////////////////////////////////////////////////////////////////////////////
// CTcComA_search_2021b specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComA_search_2021b static members
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComA_search_2021b implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComA_search_2021b)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITcA_search_2021b,ITcA_search_2021b)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComA_search_2021b)

BEGIN_OBJDATAAREA_MAP(CTcComA_search_2021b)
	...
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 2, 1, &(A_search_2021b_Obj.A_search_2021b_B), sizeof(A_search_2021b_Obj.A_search_2021b_B), OBJDATAAREA_DISABLE_SET)
END_OBJDATAAREA_MAP()

BEGIN_SETOBJPARA_MAP2(CTcComA_search_2021b,TcMatSim::GeneratedTcCom)
...
BEGIN_GETOBJPARA_MAP2(CTcComA_search_2021b,TcMatSim::GeneratedTcCom)
...
BEGIN_OBJPARAWATCH_MAP2(CTcComA_search_2021b)
...
IMPLEMENT_ITCADI(CTcComA_search_2021b)

IMPLEMENT_IPERSIST_LIB(CTcComA_search_2021b,VID_A_search_2021b,CID_A_SEARCH_2021B)

// State transition: Init -> PreOp
HRESULT CTcComA_search_2021b::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if (SUCCEEDED(hr))
	{
		...
		m_ContextInfo[0].OriginalSampleTime = 1;

	}
	if (SUCCEEDED(hr))
	{
		memset(&(AdditionalOutports.TcModuleOutput_xPointList),0,sizeof(AdditionalOutports.TcModuleOutput_xPointList));
		memset(&(AdditionalOutports.TcModuleOutput_yPointList),0,sizeof(AdditionalOutports.TcModuleOutput_yPointList));
		AdditionalInports.TcModuleInput_endNode = 0;
		AdditionalInports.TcModuleInput_xGoalEnd = 0;
		AdditionalInports.TcModuleInput_xRobotStart = 0;
		AdditionalInports.TcModuleInput_yGoalEnd = 0;
...
HRESULT CTcComA_search_2021b::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if(SUCCEEDED(hr))
	{
		...
		A_search_2021b_Obj.initialize();
		A_search_2021b_Obj.A_search_2021b_DW.endNode_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_endNode));
		A_search_2021b_Obj.A_search_2021b_DW.xGoalEnd_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_xGoalEnd));
		A_search_2021b_Obj.A_search_2021b_DW.xRobotStart_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_xRobotStart));
		A_search_2021b_Obj.A_search_2021b_DW.yGoalEnd_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_yGoalEnd));
		A_search_2021b_Obj.A_search_2021b_DW.yRobotStart_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_yRobotStart));
		A_search_2021b_Obj.A_search_2021b_DW.xPointList_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_xPointList));
		A_search_2021b_Obj.A_search_2021b_DW.yPointList_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_yPointList));
...
HRESULT CTcComA_search_2021b::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComA_search_2021b::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComA_search_2021b::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComA_search_2021b::SetObjStatePI()
{
	HRESULT hr = S_OK;

	auto fpState = FpControl(FpCtrlSection::Init);
	A_search_2021b_Obj.terminate();
...
// Constructor
CTcComA_search_2021b::CTcComA_search_2021b() :
...
HRESULT TCOMAPI CTcComA_search_2021b::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComA_search_2021b::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComA_search_2021b::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			hr = EvalMdlErrorStatus(A_search_2021b_Obj.getRTM()->errorStatus,false);
			if (hr == S_OK)
			{
				A_search_2021b_Obj.step();
				EvalMdlErrorStatus(A_search_2021b_Obj.getRTM()->errorStatus,true);
			}
...
HRESULT CTcComA_search_2021b::CheckAndAdaptCycleTimes()
{
...
// ITcA_search_2021b
HRESULT TCOMAPI CTcComA_search_2021b::step()
{
	HRESULT hr = S_OK;
	auto fpState = FpControl(FpCtrlSection::Update);
...
{
	return Create<CTcComA_search_2021b>(*pIid, pipItf);
}
