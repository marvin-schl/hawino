classdef BezierCurve < Spline
    ...
    methods
        ...
        % Constructor
        % Inputs:   [x]     x-coordinates of previous WP, control point, next WP
        ...
        function obj = BezierCurve(x, y, r, dx)
            ...
            [curvePointsX, curvePointsY] = obj.getPoint([0 : dx : 1]);
        ...
        % length(curve)]
        % Inputs:   [s]     parameter: scalar or vector, normalized or absolute
        % Outputs:  [x, y]  corresponding point (array of points) for parameter (vector)
