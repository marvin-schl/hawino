classdef BezierCurveDiff < Spline
    ...
    methods
        ...
        % Outputs:  none
        function obj = BezierCurveDiff(x, y, r, ds)
            % Initializations
        ...
        function [x,y] = getPoint(obj, s, isNormalized)
            ...
            x = 2*(obj.startPoint.x - 2*obj.controlPoint.x + obj.endPoint.x)*t + (2*obj.controlPoint.x - 2*obj.startPoint.x);
            y = 2*(obj.startPoint.y - 2*obj.controlPoint.y + obj.endPoint.y)*t + (2*obj.controlPoint.y - 2*obj.startPoint.y);
        end
        % -----------------------------------------------------------------
    end
