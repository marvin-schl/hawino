...
// *************************************************************
#ifndef _FbsimpleObserver2withKalman__h_INCLUDED
#define _FbsimpleObserver2withKalman__h_INCLUDED
...
#include "simpleObserver2withKalmanDuts.h"
#include "simpleObserver2withKalmanInterfaces.h"
#include "simpleObserver2withKalmanVersion.h"

class CFbsimpleObserver2withKalman :
	public TcMatSim::GeneratedPou
{
public:

	inline void operator()() {this->FB_Main();}
	inline GUID get_VersionID() {return VID_simpleObserver2withKalman;}
	inline CLSID get_ClassID() {return CID_FB_SIMPLEOBSERVER2WITHKALMAN;}

	DECLARE_FUNC_MAP_FB()

	CFbsimpleObserver2withKalman();
	~CFbsimpleObserver2withKalman();
	bool FB_Main();
	static void _FB_Main(ST_FB_Main_FB_simpleObserver2withKalman* ST_Param);
	bool FB_exit(bool bInCopyCode);
	static void _FB_exit(ST_FB_exit_FB_simpleObserver2withKalman* ST_Param);
	bool FB_init(bool bInitRetains, bool bInCopyCode);
	static void _FB_init(ST_FB_init_FB_simpleObserver2withKalman* ST_Param);
	...
	PVOID PsimpleObserver2withKalman_M;


};
TYPESIZE_VALIDATION2(CFbsimpleObserver2withKalman,192,200);

			
#endif // _FbsimpleObserver2withKalman__h_INCLUDED
