...
class CsimpleObserver2withKalmanCtrl  : public ITcOCFCtrlImpl< CsimpleObserver2withKalmanCtrl, CsimpleObserver2withKalmanClassFactory>
{
	public:
	CsimpleObserver2withKalmanCtrl () {};
...
extern "C" __declspec(dllexport) HRESULT APIENTRY DllGetTcCtrl(ITcCtrl** ppTcCtrl)
{
	...
	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CsimpleObserver2withKalmanCtrl>;
		pTcCtrl->AddRef();
		*ppTcCtrl = pTcCtrl;
		hr = S_OK;
	}
