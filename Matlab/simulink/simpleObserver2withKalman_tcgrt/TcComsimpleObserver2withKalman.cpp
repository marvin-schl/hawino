// ****************** TcComsimpleObserver2withKalman.cpp *************************
...
#include "TcComsimpleObserver2withKalman.h"
...
///////////////////////////////////////////////////////////////////////////////
// CTcComsimpleObserver2withKalman specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComsimpleObserver2withKalman static members
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComsimpleObserver2withKalman implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComsimpleObserver2withKalman)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITcsimpleObserver2withKalman,ITcsimpleObserver2withKalman)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComsimpleObserver2withKalman)

BEGIN_OBJDATAAREA_MAP(CTcComsimpleObserver2withKalman)
	...
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 2, 1, PsimpleObserver2withKalman_M->blockIO, sizeof(*(PsimpleObserver2withKalman_M->blockIO)), OBJDATAAREA_DISABLE_SET)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 3, 1, PsimpleObserver2withKalman_M->contStates, sizeof(*(PsimpleObserver2withKalman_M->contStates)), OBJDATAAREA_DISABLE_SET)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 4, 1, &(PsimpleObserver2withKalman_M->dwork->CameraDelay_DSTATE), 4952, OBJDATAAREA_DISABLE_SET)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 5, 1, &(PsimpleObserver2withKalman_M->dwork->Integrator_IWORK), 5, OBJDATAAREA_DISABLE_SET)
END_OBJDATAAREA_MAP()

BEGIN_SETOBJPARA_MAP2(CTcComsimpleObserver2withKalman,TcMatSim::GeneratedTcCom)
	...
	SETOBJPARA_VALUE_DENIED(0x0000000c,rtmGetT(PsimpleObserver2withKalman_M))
...
BEGIN_GETOBJPARA_MAP2(CTcComsimpleObserver2withKalman,TcMatSim::GeneratedTcCom)
	...
	GETOBJPARA_VALUE_LOCK(0x0000000c, rtmGetT(PsimpleObserver2withKalman_M), 0, VarAccess(Access::None,Access::Read))
...
BEGIN_OBJPARAWATCH_MAP2(CTcComsimpleObserver2withKalman)
...
IMPLEMENT_ITCADI(CTcComsimpleObserver2withKalman)

IMPLEMENT_IPERSIST_LIB(CTcComsimpleObserver2withKalman,VID_simpleObserver2withKalman,CID_SIMPLEOBSERVER2WITHKALMAN)

// State transition: Init -> PreOp
HRESULT CTcComsimpleObserver2withKalman::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if (SUCCEEDED(hr))
	{
		...
		AdditionalInports.TcModuleInput_Estimator1_UseSimpleNotKalman = 0;
...
HRESULT CTcComsimpleObserver2withKalman::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if(SUCCEEDED(hr))
	{
		...
		::simpleObserver2withKalman_initialize(PsimpleObserver2withKalman_M);
		PsimpleObserver2withKalman_M->dwork->K_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_Estimator1_K));
		PsimpleObserver2withKalman_M->dwork->Reset_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_Estimator1_Reset));
		PsimpleObserver2withKalman_M->dwork->UseSimpleNotKalman_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_Estimator1_UseSimpleNotKalman));
		PsimpleObserver2withKalman_M->dwork->cameraDelayCylces_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_Estimator1_cameraDelayCylces));
		PsimpleObserver2withKalman_M->dwork->InCameraPose_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InCameraPose));
		PsimpleObserver2withKalman_M->dwork->InVThetaworld_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InVThetaworld));
		PsimpleObserver2withKalman_M->dwork->InVXworld_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InVXworld));
		PsimpleObserver2withKalman_M->dwork->InVYworld_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InVYworld));
		PsimpleObserver2withKalman_M->dwork->OutEstimatedPose_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_OutEstimatedPose));
		PsimpleObserver2withKalman_M->dwork->version_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_version));
...
HRESULT CTcComsimpleObserver2withKalman::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComsimpleObserver2withKalman::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComsimpleObserver2withKalman::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComsimpleObserver2withKalman::SetObjStatePI()
{
	HRESULT hr = S_OK;

	auto fpState = FpControl(FpCtrlSection::Init);
	if (PsimpleObserver2withKalman_M!=NULL)
	{
		::simpleObserver2withKalman_terminate(PsimpleObserver2withKalman_M);
...
// Constructor
CTcComsimpleObserver2withKalman::CTcComsimpleObserver2withKalman() :
...
HRESULT TCOMAPI CTcComsimpleObserver2withKalman::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComsimpleObserver2withKalman::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComsimpleObserver2withKalman::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			hr = EvalMdlErrorStatus(PsimpleObserver2withKalman_M->errorStatus,false);
			if (hr == S_OK)
			{
				::simpleObserver2withKalman_step(PsimpleObserver2withKalman_M);
				EvalMdlErrorStatus(PsimpleObserver2withKalman_M->errorStatus,true);
			}
...
HRESULT CTcComsimpleObserver2withKalman::CheckAndAdaptCycleTimes()
{
	...
	{
		PsimpleObserver2withKalman_M->solverInfo->fixedStepSize *= fCycleTimeMultiplier;
		(*PsimpleObserver2withKalman_M->solverInfo->stepSizePtr) *= fCycleTimeMultiplier;
	}
	return hr;
}

// ITcsimpleObserver2withKalman
HRESULT TCOMAPI CTcComsimpleObserver2withKalman::simpleObserver2withKalman_step()
{
	HRESULT hr = S_OK;
	auto fpState = FpControl(FpCtrlSection::Update);
...
{
	return Create<CTcComsimpleObserver2withKalman>(*pIid, pipItf);
}
