...
class CsimpleObserver2Ctrl  : public ITcOCFCtrlImpl< CsimpleObserver2Ctrl, CsimpleObserver2ClassFactory>
{
	public:
	CsimpleObserver2Ctrl () {};
...
extern "C" __declspec(dllexport) HRESULT APIENTRY DllGetTcCtrl(ITcCtrl** ppTcCtrl)
{
	...
	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CsimpleObserver2Ctrl>;
		pTcCtrl->AddRef();
		*ppTcCtrl = pTcCtrl;
		hr = S_OK;
	}
