...
MODEL_NAME     = simpleObserver2
DEFINES_OTHER  = -DMODEL=simpleObserver2 -DNUMST=2 -DNCSTATES=3 -DHAVESTDIO -DRT -DUSE_RTMODEL

#------------------------ model referencing ----------------------------------
MODELREFS                 = 
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = simpleObserver2_ref.rsp
