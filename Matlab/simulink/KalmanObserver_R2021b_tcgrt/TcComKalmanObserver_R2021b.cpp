// ****************** TcComKalmanObserver_R2021b.cpp *************************
...
#include "TcComKalmanObserver_R2021b.h"
...
///////////////////////////////////////////////////////////////////////////////
// CTcComKalmanObserver_R2021b specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComKalmanObserver_R2021b static members
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComKalmanObserver_R2021b implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComKalmanObserver_R2021b)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITcKalmanObserver_R2021b,ITcKalmanObserver_R2021b)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComKalmanObserver_R2021b)

BEGIN_OBJDATAAREA_MAP(CTcComKalmanObserver_R2021b)
	...
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 3, 1, &(KalmanObserver_R2021b_DW.CameraDelay_DSTATE), 504, OBJDATAAREA_DISABLE_SET)
END_OBJDATAAREA_MAP()
...
BEGIN_SETOBJPARA_MAP2(CTcComKalmanObserver_R2021b,TcMatSim::GeneratedTcCom)
	...
	SETOBJPARA_VALUE_DENIED(0x0000000c,rtmGetT(KalmanObserver_R2021b_M))
...
BEGIN_GETOBJPARA_MAP2(CTcComKalmanObserver_R2021b,TcMatSim::GeneratedTcCom)
	...
	GETOBJPARA_VALUE_LOCK(0x0000000c, rtmGetT(KalmanObserver_R2021b_M), 0, VarAccess(Access::None,Access::Read))
...
BEGIN_OBJPARAWATCH_MAP2(CTcComKalmanObserver_R2021b)
...
IMPLEMENT_ITCADI(CTcComKalmanObserver_R2021b)

IMPLEMENT_IPERSIST_LIB(CTcComKalmanObserver_R2021b,VID_KalmanObserver_R2021b,CID_KALMANOBSERVER_R2021B)

// State transition: Init -> PreOp
HRESULT CTcComKalmanObserver_R2021b::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;

	hr = SingleInstanceLock(ipSrv, {0xB58DDB04, 0xBFC8, 0x3E5A, {0x9B, 0x86, 0x83, 0x7C, 0xD0, 0x76, 0xF4, 0xEF}});
	if (SUCCEEDED(hr))
	{
	...
	if (SUCCEEDED(hr))
	{
		...
		memset(&(AdditionalOutports.TcModuleOutput_OutSimpleObsPose),0,sizeof(AdditionalOutports.TcModuleOutput_OutSimpleObsPose));
		memset(&(AdditionalOutports.TcModuleOutput_OutSimpleObsPose1),0,sizeof(AdditionalOutports.TcModuleOutput_OutSimpleObsPose1));
...
HRESULT CTcComKalmanObserver_R2021b::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if(SUCCEEDED(hr))
	{
		...
		KalmanObserver_R2021b_DW.InCameraPose_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InCameraPose));
		KalmanObserver_R2021b_DW.InVThetaworld_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InVThetaworld));
		KalmanObserver_R2021b_DW.InVXworld_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InVXworld));
		KalmanObserver_R2021b_DW.InVYworld_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_InVYworld));
		KalmanObserver_R2021b_DW.omegaToRobot_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_omegaToRobot));
		KalmanObserver_R2021b_DW.vxToRobot_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_vxToRobot));
		KalmanObserver_R2021b_DW.vyToRobot_PWORK = reinterpret_cast<PVOID>(&(AdditionalInports.TcModuleInput_vyToRobot));
		KalmanObserver_R2021b_DW.DEBUG_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_DEBUG));
		KalmanObserver_R2021b_DW.OutSimpleObsPose_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_OutSimpleObsPose));
		KalmanObserver_R2021b_DW.OutSimpleObsPose1_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_OutSimpleObsPose1));
		KalmanObserver_R2021b_DW.version_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_version));
...
HRESULT CTcComKalmanObserver_R2021b::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComKalmanObserver_R2021b::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComKalmanObserver_R2021b::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComKalmanObserver_R2021b::SetObjStatePI()
{
	HRESULT hr = S_OK;
...
// Constructor
CTcComKalmanObserver_R2021b::CTcComKalmanObserver_R2021b() :
...
HRESULT TCOMAPI CTcComKalmanObserver_R2021b::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComKalmanObserver_R2021b::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComKalmanObserver_R2021b::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			hr = EvalMdlErrorStatus(KalmanObserver_R2021b_M->errorStatus,false);
			if (hr == S_OK)
			{
				::KalmanObserver_R2021b_step();
				EvalMdlErrorStatus(KalmanObserver_R2021b_M->errorStatus,true);
			}
...
HRESULT CTcComKalmanObserver_R2021b::CheckAndAdaptCycleTimes()
{
	...
	{
		KalmanObserver_R2021b_M->solverInfo.fixedStepSize *= fCycleTimeMultiplier;
		(*KalmanObserver_R2021b_M->solverInfo.stepSizePtr) *= fCycleTimeMultiplier;
	}
	return hr;
}

// ITcKalmanObserver_R2021b
HRESULT TCOMAPI CTcComKalmanObserver_R2021b::KalmanObserver_R2021b_step()
{
	HRESULT hr = S_OK;
	auto fpState = FpControl(FpCtrlSection::Update);
...
{
	return Create<CTcComKalmanObserver_R2021b>(*pIid, pipItf);
}
