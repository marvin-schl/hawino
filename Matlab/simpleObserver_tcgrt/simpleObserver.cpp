 ...
 * C++ source code generated on : Thu Mar  9 19:23:27 2023
 *
...
void simpleObserver_step(void)
{
  ...
  simpleObserver_B.Integrator[0] = simpleObserver_X.Integrator_CSTATE_o[0];
  simpleObserver_B.Integrator[1] = simpleObserver_X.Integrator_CSTATE_o[1];
  simpleObserver_B.Integrator[2] = simpleObserver_X.Integrator_CSTATE_o[2];

  /* S-Function (TcModuleInOut): '<Root>/K' */
  if (simpleObserver_DW.K_PWORK != NULL) {
    memcpy(&simpleObserver_B.K[0], simpleObserver_DW.K_PWORK, 72);
  }

  /* Sum: '<Root>/Sum' */
  simpleObserver_B.Sum[0] = simpleObserver_B.estimatedX -
    simpleObserver_B.Integrator[0];
  simpleObserver_B.Sum[1] = simpleObserver_B.estimatedY -
    simpleObserver_B.Integrator[1];
  simpleObserver_B.Sum[2] = simpleObserver_B.estimatedTheta -
    simpleObserver_B.Integrator[2];
  for (k = 0; k < 3; k++) {
    /* Product: '<Root>/Product' incorporates:
     *  S-Function (TcModuleInOut): '<Root>/K'
     */
    simpleObserver_B.Product[k] = 0.0;
    simpleObserver_B.Product[k] += simpleObserver_B.K[k] * simpleObserver_B.Sum
      [0];
    simpleObserver_B.Product[k] += simpleObserver_B.K[k + 3] *
      simpleObserver_B.Sum[1];
    simpleObserver_B.Product[k] += simpleObserver_B.K[k + 6] *
      simpleObserver_B.Sum[2];
  }
  ...
  /* Sum: '<Root>/Sum1' */
  simpleObserver_B.Sum1_e[0] = simpleObserver_B.Product[0] +
    simpleObserver_B.vxToRobot;
  simpleObserver_B.Sum1_e[1] = simpleObserver_B.Product[1] +
    simpleObserver_B.vyToRobot;
  simpleObserver_B.Sum1_e[2] = simpleObserver_B.Product[2] +
  ...
  if (rtmIsMajorTimeStep(simpleObserver_M)) {
    ...
    /* Update for S-Function (TcModuleInOut): '<Root>/Kout' */
    if (simpleObserver_DW.Kout_PWORK != NULL) {
      memcpy(simpleObserver_DW.Kout_PWORK, &simpleObserver_B.K[0], 72);
    }
...
void simpleObserver_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE_o[0] = simpleObserver_B.Sum1_e[0];
  ...
  /* Derivatives for Integrator: '<Root>/Integrator' */
  _rtXdot->Integrator_CSTATE_o[1] = simpleObserver_B.Sum1_e[1];
  ...
  /* Derivatives for Integrator: '<Root>/Integrator' */
  _rtXdot->Integrator_CSTATE_o[2] = simpleObserver_B.Sum1_e[2];
}
...
void simpleObserver_initialize(void)
{
  ...
  simpleObserver_X.Integrator_CSTATE_o[0] = simpleObserver_P.Integrator_IC_g;
  ...
  /* InitializeConditions for Integrator: '<Root>/Integrator' */
  simpleObserver_X.Integrator_CSTATE_o[1] = simpleObserver_P.Integrator_IC_g;
  ...
  /* InitializeConditions for Integrator: '<Root>/Integrator' */
  simpleObserver_X.Integrator_CSTATE_o[2] = simpleObserver_P.Integrator_IC_g;
