...
class CDraftSimpleEstimatorANDControlCtrl  : public ITcOCFCtrlImpl< CDraftSimpleEstimatorANDControlCtrl, CDraftSimpleEstimatorANDControlClassFactory>
{
	public:
	CDraftSimpleEstimatorANDControlCtrl () {};
...
extern "C" __declspec(dllexport) HRESULT APIENTRY DllGetTcCtrl(ITcCtrl** ppTcCtrl)
{
	...
	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CDraftSimpleEstimatorANDControlCtrl>;
		pTcCtrl->AddRef();
		*ppTcCtrl = pTcCtrl;
		hr = S_OK;
	}
