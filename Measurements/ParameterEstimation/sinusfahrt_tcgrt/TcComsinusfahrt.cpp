...
///////////////////////////////////////////////////////////////////////////////
// CTcComsinusfahrt specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComsinusfahrt static members
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComsinusfahrt implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComsinusfahrt)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITcsinusfahrt,ITcsinusfahrt)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComsinusfahrt)

BEGIN_OBJDATAAREA_MAP(CTcComsinusfahrt)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 0, 1, &(AdditionalOutports), sizeof(AdditionalOutports), OBJDATAAREA_DISABLE_SET)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 1, 1, Psinusfahrt_M->blockIO, sizeof(*(Psinusfahrt_M->blockIO)), OBJDATAAREA_DISABLE_SET)
	OBJDATAAREA_SPAN_PTR_SIZE_FLAGS( 2, 1, &(Psinusfahrt_M->dwork->counter), sizeof(Psinusfahrt_M->dwork->counter), OBJDATAAREA_DISABLE_SET)
END_OBJDATAAREA_MAP()

BEGIN_SETOBJPARA_MAP2(CTcComsinusfahrt,TcMatSim::GeneratedTcCom)
...
BEGIN_GETOBJPARA_MAP2(CTcComsinusfahrt,TcMatSim::GeneratedTcCom)
...
BEGIN_OBJPARAWATCH_MAP2(CTcComsinusfahrt)
...
IMPLEMENT_ITCADI(CTcComsinusfahrt)

IMPLEMENT_IPERSIST_LIB(CTcComsinusfahrt,VID_sinusfahrt,CID_SINUSFAHRT)

// State transition: Init -> PreOp
HRESULT CTcComsinusfahrt::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if (SUCCEEDED(hr))
	{
		...
		memset(&(AdditionalOutports.TcModuleOutput_vxSLX),0,sizeof(AdditionalOutports.TcModuleOutput_vxSLX));
...
HRESULT CTcComsinusfahrt::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if(SUCCEEDED(hr))
	{
		...
		::sinusfahrt_initialize(Psinusfahrt_M);
		Psinusfahrt_M->dwork->vxSLX_PWORK = reinterpret_cast<PVOID>(&(AdditionalOutports.TcModuleOutput_vxSLX));
...
HRESULT CTcComsinusfahrt::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComsinusfahrt::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComsinusfahrt::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComsinusfahrt::SetObjStatePI()
{
	HRESULT hr = S_OK;

	auto fpState = FpControl(FpCtrlSection::Init);
	if (Psinusfahrt_M!=NULL)
	{
		::sinusfahrt_terminate(Psinusfahrt_M);
		Psinusfahrt_M = NULL;
	}
...
// Constructor
CTcComsinusfahrt::CTcComsinusfahrt() :
...
HRESULT TCOMAPI CTcComsinusfahrt::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComsinusfahrt::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComsinusfahrt::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			hr = EvalMdlErrorStatus(Psinusfahrt_M->errorStatus,false);
			if (hr == S_OK)
			{
				::sinusfahrt_step(Psinusfahrt_M);
				EvalMdlErrorStatus(Psinusfahrt_M->errorStatus,true);
			}
...
HRESULT CTcComsinusfahrt::CheckAndAdaptCycleTimes()
{
...
// ITcsinusfahrt
HRESULT TCOMAPI CTcComsinusfahrt::sinusfahrt_step()
{
	HRESULT hr = S_OK;
	auto fpState = FpControl(FpCtrlSection::Update);
...
{
	return Create<CTcComsinusfahrt>(*pIid, pipItf);
}
